...
SECTIONS = {
    "characters": {
        "title": "Characters",
        "intro": "This section contains character pages for Gravity Falls.",
        "list_title": "Character List",
    },
    "organizations": {
        "title": "Organizations",
        "intro": "This section contains organizations, schools, groups, and institutions from Gravity Falls.",
        "list_title": "Organization List",
    },
    "seasons": {
        "title": "Seasons",
        "intro": "This section organizes Gravity Falls by seasons.",
